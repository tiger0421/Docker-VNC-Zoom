...
docker run --rm  --privileged -p 6080:80 -p 5900:5900 -v /dev:/dev tige0421/docker_vnc_zoom:latest
```
...
docker run --rm  --privileged -p 6080:80 -p 5900:5900 -v /dev:/dev docker_vnc_zoom:latest
```
